...
export default function HeaderSection() {
    ...
    return (<Header mode="horizontal" onClick={handleCLickTabNav} selectedKeys={[current]} items={headerMenu}>
        <div style={{
            display: 'flex',
            paddingTop: '.7rem',
            marginBottom: '.78rem',
            ...
            <Spacer size={15} />
            <MenuLogout menu={<WrapperMenuLogout>
                <WrapeprProfile>
                    <ICAccount />
                    <div>
                ...
                <a style={{
                    color: '#000'
                }} target="_blank" href="https://accounts.edot.id/infopribadi" rel="noopener noreferrer">
