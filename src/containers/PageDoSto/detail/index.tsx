...
export default function PageDoStoDetail() {
    ...
    const dataList = [
        ...
        createDataList('Receiving Branch', `${data.receive_branch_id} - ${data.receive_branch_name || ''}`),
        ...
        createDataList('Header Text', ((data.header_text != '' && data.header_text != null) ? data.header_text : '-')),
