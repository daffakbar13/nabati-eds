    ...
    return (
        <>
            <List loading={loading}>
                <List.Item label='Mov. Type' value={`${details?.movement_type_id}-${toTitleCase(details?.movement_type_name)}`} />
                <List.Item label='Branch' value={`${details?.branch_id}-${toTitleCase(details?.branch_name)}`} />
                <List.Item label='Vendor' value={`${details?.vendor_id}-${toTitleCase(details?.vendor_name)}`} />
