...
export default function PageConfigurationSloc() {
  ...
  const handleChangeStatus = async () => {
    try {
      const res = updateStatusShippingType(
        {
  ...
  return (
    <>
      <Text variant={'h4'}>Shipping Type</Text>
      <Spacer size={20} />
      <Card style={{ overflow: 'unset' }}>
        <Row justifyContent="space-between">
          <Row gap="16px">
            <Search {...searchProps} rowKey="id" />
          </Row>
          <Row gap="16px">
            <RowAntd gutter={10}>
              <ColAntd>
          ...
          <FloatAction>
            <RowAntd justify="space-between" style={{ flexGrow: 1 }}>
              <b style={{ lineHeight: '48px' }}>
                {table.state.selected.length} Shipping Type are Selected
              </b>
              <RowAntd gutter={10}>
                <ColAntd>
                  <Button
      ...
      <Modal
        ...
        content={
          <>
            Are you sure want Delete Shipping Type{' '}
            {oneSelected ? (
        ...
        successContent={(res: any) => `Shipping Type has been successfully deleted`}
        successOkText="OK"
        width={432}
      />
      <Modal
        ...
        successContent={(res: any) => `Shipping Type has been successfully 
