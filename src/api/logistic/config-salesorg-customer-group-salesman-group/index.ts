...
export const getDetailSalesORGCustomerGroupCustomerGroup = async (company_id: string, sales_org_id: string, channel_id: string, customer_group_id: string, salesman_group_id: string, min_line: string) => {
    const response = await call({
        method: METHODS.GET,
...
export const updateSalesORGCustomerGroupCustomerGroup = async (company_id: string, sales_org_id: string, channel_id: string, customer_group_id: string, salesman_group_id: string, min_line: string, payload: any) => {
    const response = await call({
        method: METHODS.PUT,
...
export const UpdateStatusSalesORGCustomerGroupCustomerGroup = async (company_id: string, sales_org_id: string, channel_id: string, customer_group_id: string, salesman_group_id: string, min_line: string, payload: any) => {
    const response = await call({
        method: METHODS.PUT,
