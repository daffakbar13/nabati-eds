export interface GoodRecepitList {
  ...
  export interface GoodRecepitListDetail {
    readonly company_id: string
    readonly company_name: string
    readonly id: string
    readonly gi_number: string
    ...
    readonly modified_at: string
    readonly modified_by: string
    readonly items: Array<GoodRecepitListDetailItems>
  }

  export interface GoodRecepitListDetailItems {
    readonly company_id: string
    readonly id: string
