...
export const updateCustomerGroup = async (sales_org_id: string, customer_group_id: string, payload: any) => {
    const response = await call({
        method: METHODS.POST,
...
export const UpdateStatusCustomerGroup = async (sales_org_id: string, customer_group_id: string, payload: any) => {
    const response = await call({
        method: METHODS.POST,
